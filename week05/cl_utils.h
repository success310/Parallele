...
// extends the given value to a multiple of the step value
size_t extendToMultiple(size_t value, size_t step);
...
size_t extendToMultiple(size_t value, size_t step) {
    return (value % step == 0) ? value : (value + (step - (value % step)));
}